<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MDContrasena.aspx.cs" Inherits="easyEvent.MDContraseña" %>
        ...
        <div class="medio">
            ...
            <p>Ingrese la nueva contraseña</p>
                ...
                <div class="form-floating">
                    <asp:TextBox ID="txt_Pass1" type="Password" placeholder="Contraseña" class="form-control"   runat="server"  ></asp:TextBox>
                    <label for="txt_Pass1">Contraseña</label>
                </div>
                <br />
                <div class="form-floating">
                    <asp:TextBox ID="txt_Pass2" type="Password" class="form-control"  placeholder="Contraseña"  runat="server" ></asp:TextBox>
                    <label for="txt_Pass2">Repita la contraseña</label>
                </div>
                <br />
                    <asp:Button ID="BtnMod" OnClick="BTNGuardar" class="btn btn-primary" runat="server" Text="Guardar"  />
                    &nbsp;
